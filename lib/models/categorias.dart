...
final List<Categoria> categoriasGasto = [
  ...
  Categoria(
      id: 2, nombre: 'Educación', icono: Icons.school, color: Colors.green),
  Categoria(
      id: 3,
      nombre: 'Gasolina',
      ...
      color: Colors.red),
  Categoria(
      id: 4, nombre: 'Moto', icono: Icons.motorcycle, color: Colors.purple),
  Categoria(
      id: 5,
      nombre: 'Teléfono',
...
final List<Categoria> categoriasIngreso = [
  Categoria(
      id: 12, nombre: 'Salario', icono: Icons.attach_money, color: Colors.teal),
  Categoria(
      id: 13,
      nombre: 'Inversiones',
  ...
  Categoria(
      id: 15, nombre: 'Freelance', icono: Icons.work, color: Colors.indigo),
  Categoria(
      id: 16,
      nombre: 'Regalos',
  ...
  Categoria(
      id: 17, nombre: 'Alquiler', icono: Icons.apartment, color: Colors.brown),
  Categoria(
      id: 18,
